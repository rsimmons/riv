...
import { layoutStreamExpressionNode, TreeViewContext, layoutStreamBindingNode, TreeViewDisplayOptions } from './TreeView';
...
export const MultiChooser: React.FC<{context: MultiChooserContext, existingNode: Node | null, localEnv: StaticEnvironment, treeViewDisplayOpts: TreeViewDisplayOptions, onCommitChoice: (node: Node) => void, onAbort: () => void}> = ({ context, existingNode, localEnv, treeViewDisplayOpts, onCommitChoice, onAbort }) => {
